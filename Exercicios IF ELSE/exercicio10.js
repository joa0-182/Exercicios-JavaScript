...
var saldoMedio = Number.parseFloat(prompt("Digite o saldo medio"))
...
window.alert(`O valor do crédito é de: ${valorCredito.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}`)